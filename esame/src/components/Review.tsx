...
//COMPONTE DELLA SINGOLA RECENSIONE CHE PRENDE COME PARAMETRO LA PROP CHE GLI SERVE PER MOSTRARE I DATI DELLA RECENSIONE
  ...
  return (
    ...
    <div className={style.review_container}>
      ...
      <div className={style.review_first_row}>
        {/* SE L'IMMAGINE PROFILO NON C'è NE VIENE MESSA UNA VUOTA DI DEFAULT */}
      ...
      {/* PARTE DI RECENSIONE CON IL RATING E IL TITOLO */}
      ...
      {/* PARTE DI RECENSIONE CON LA DATA E LA DESCRIZIONE */}
      <div>
