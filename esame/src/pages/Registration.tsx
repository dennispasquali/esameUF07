...
function Registration() {
  ...
  //API POST PER MANDARE I DATI DELLA REGISTRAZIONE AL BACKEND
  const { mutate, isPending } = useApiPost<IRegistration, IUserJWT>('http://localhost:3000/api/registration/submit');
  const navigate = useNavigate();


  /**
   * FUNZIONE CHE SI OCCUPA DI GESTIRE L'INVIO DEI DATI DI REGISTRAZIONE
  ...
  */
  ...
  /**
   * FUNZIONE CHE SI OCCUPA DI GESTIRE L'AGGIORNAMENTO DEL PREFISSO
   * * @param prefix string - prefisso scritto dall'utente
   * @returns void (aggiorna gli useState)
  */
  ...
  /**
   * FUNZIONE CHE SI OCCUPA DI GESTIRE L'AGGIORNAMENTO DEL NR DI TELEFONO
   * * @param tel string - nr telefono scritto dall'utente
   * @returns void (aggiorna gli useState)
  */
  ...
  /**
   * FUNZIONE CHE SI OCCUPA DI GESTIRE L'AGGIORNAMENTO DEL CIVICO
   * * @param c string - civico scritto dall'utente
   * @returns void (aggiorna gli useState)
  */
  ...
  /**
   * FUNZIONE CHE SI OCCUPA DI GESTIRE NEL PRIMO CAMPO PWD PER VEDERE SE LE PWD COINCIDONO
   * * @param pwd string - password scritta dall'utente
   * @returns void (aggiorna gli useState)
  */
  ...
  /**
   * FUNZIONE CHE SI OCCUPA DI GESTIRE NEL SECONDO CAMPO PWD PER VEDERE SE LE PWD COINCIDONO
   * * @param pwd string - password scritta dall'utente
   * @returns void (aggiorna gli useState)
  */
  ...
  return (
    <>
      ...
      {/* SEZIONE SNACKBAR PER MOSTRARE EVENTUALI ERRORI */}
      {genericError != "" ?
