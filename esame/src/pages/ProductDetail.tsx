...
//COMPONENTE PAGINA DETTAGLIO DEL PRODOTTO
function ProductDetail() {
  ...
  //USE STATE PER APRIRE LA REVIEW DIALOG
  ...
  //SNACKBAR PER GESTIRE LE SNACK DELLE CHIAMATE API PER LE REVIEW E PER APRIRE LA FINESTRA MODALE DELLE RECENSIONI
  ...
  //Se esiste Altrimenti imposta null.
  const user: IUserProfile | null = storedUserString ? JSON.parse(storedUserString) : null;
  //API POST PER AGGIUNGERE I PRODOTTI AL CARRELLO
  ...
  /**
     * FUNZIONE CHE SI OCCUPA DI AGGIUNGERE IL PRODOTTO AL CARRELLO CON LA QUANTITA SELEZIONATA
  ...
  */
  ...
  /**
    * FUNZIONE CHE SI OCCUPA DI AGGIUNGERE I DATI UTENTE PER LA FINESTRA MODALE
    * @returns void (aggiorna gli useState)
 */
  ...
  //FUNZIONE CHE CHIUDE LA FINESTRA MODALE PER SCRIVERE LE RECENSIONI
  const handleClose = () => {
    setOpenDialog(false);
  };
  ...
  /**
    * FUNZIONE CHE SI OCCUPA DI GESTIRE L'AGGIUNTA DELLA QUANTITA DI PRODOTTO
    * @returns void (aggiorna gli useRef della quantita)
 */
    ...
    <>
      ...
      <div className={style.pdp_container}>
        ...
        <div className={style.product_main_section}>
          ...
          {/* La "Buy Box" (Colonna destra per l'acquisto) */}
